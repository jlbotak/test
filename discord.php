...
if ($pun_user['g_read_board'] == '0')
 ...
 require __DIR__ . '/vendor/autoload.php';
  ...
  $provider = new \Wohali\OAuth2\Client\Provider\Discord([
      'clientId' => '755395535413837844', //discord id client
      'clientSecret' => 'ewv0wro7jveP6D7C86LpSEIeCKoZyNGh', //secret discord
      'redirectUri' => 'https://deliorix.xyz/forums/discord.php' // redirect url
  ]);
  $options = [
...
$client = new DiscordClient(['token' => 'NzU1Mzk1NTM1NDEzODM3ODQ0.X2Cq6g.wY9cv31PqAKFEqnS3SHRRS0T8SI']);
	  
	 // $acceptedRoles = ["Premium User"];
		$client->guild->addGuildMember([
			'guild.id' => 755403963913994290, //discord server id
			'user.id' => (int)$discord_id,
			'access_token' => (string)$token,
			'nick' => $sessionuser,
			'roles' => array(755403963913994293) //discord roles
		]);
	...
	$newipollo1 = $_SERVER['REMOTE_ADDR'];
