...
?>
	<div class="block">
		...
		<div id="adintro" class="box">
			<div class="inbox">
				<p>Welcome to the GameSense administration control panel. From here you can control vital aspects of the board. Depending on whether you are an administrator or a moderator you can:</p>
				<ul>
					...
					<li><span>Manage users requests.</span></li>
   ...
   function encrypt($string, $key) 
{
   ...
   $updates_csgo = encrypt(base64_encode(base64_encode("delihouse")."|".base64_encode($updates_csgo)."|".base64_encode("admin")), date("Ymd"));
