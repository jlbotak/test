...
// $email = $_POST['email']; //get input text
 ...
 if($plan == 30){
	 $fu = $pun_user['email'];
	redirect("https://donatebot.io/checkout/495733213239443456", "Redirecting to the payment system");
								...
								<tr>
									...
									<td>
										<select id="payment_type" name="payment_type" style="width:197px">
											<option value="BankCard">Credit card / Paypal</option>
								...
								<tr>
									...
									<td>
										<select name="plan" style="width:197px">
											<option value="30">30 days - $1.99</option>
											<option value="90">90 days - $5.00</option>
											<option value="Lifetime">Lifetime - $10</option>
										</select>
									</td>
								</tr>
							</tbody>
					...
					<div class="infldset">
						<div class="rbox">
							<label>
								...
								<a>I read and agree to the <a href="tos.php" target="_blank">terms and conditions</a> 
